...
var Role = function () {
    ...
    var Role = _classThis = /** @class */ (function () {
        function Role_1() {
            ...
            this.users = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _users_initializers, void 0));
    ...
    (function () {
        ...
        _name_decorators = [(0, swagger_1.ApiProperty)({ description: 'Nombre del rol', example: 'Administrador' }), (0, typeorm_1.Column)()];
        _description_decorators = [(0, swagger_1.ApiProperty)({ description: 'Descripción del rol', example: 'Acceso completo al sistema' }), (0, typeorm_1.Column)({ nullable: true })];
