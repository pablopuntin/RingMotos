...
var CreateSupplierDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateSupplierDto() {
                ...
                __runInitializers(this, _totalDebtCache_extraInitializers);
            }
            return CreateSupplierDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, swagger_1.ApiProperty)({ description: "Nombre del proveedor", example: "Ferretería López" }), (0, class_validator_1.IsString)()];
            _cuit_decorators = [(0, swagger_1.ApiProperty)({ description: "CUIT del proveedor", example: "20-12345678-9" }), (0, class_validator_1.IsString)()];
            _phone_decorators = [(0, swagger_1.ApiProperty)({ description: "Teléfono del proveedor", example: "3857408499" }), (0, class_validator_1.IsString)()];
            _email_decorators = [(0, swagger_1.ApiProperty)({ description: "Correo electrónico del proveedor", example: "proveedor@mail.com" }), (0, class_validator_1.IsEmail)()];
            _address_decorators = [(0, swagger_1.ApiProperty)({ description: "Dirección del proveedor", example: "Av. Belgrano 123" }), (0, class_validator_1.IsString)()];
            _totalDebtCache_decorators = [(0, swagger_1.ApiProperty)({ description: "Deuda total del proveedor en caché", example: 5000.00, required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsNumber)()];
