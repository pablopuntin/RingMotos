...
exports.ApplyAdjustmentDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var ApplyAdjustmentDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _amount_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Monto de ajuste', example: 1500.75 }), (0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)()];
            _description_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Descripción del movimiento', example: 'Ajuste fijo, puede ser positivo para amentar un saldo o negativopara restarle un monto al saldo' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
...
exports.ApplyAdjustmentDto = ApplyAdjustmentDto;
